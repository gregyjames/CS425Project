CREATE TABLE `administrator` (
    ...
    PRIMARY KEY (`admin_id`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;

CREATE TABLE `calendar` (
    `reservation_date` date NOT NULL,
    `reservation_time` time NOT NULL,
    PRIMARY KEY (`reservation_date`, `reservation_time`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `members` (
    ...
    PRIMARY KEY (`member_id`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;

CREATE TABLE `non_member` (
    `non_member_id` int (11) NOT NULL AUTO_INCREMENT,
    `full_name` varchar(100) NOT NULL,
    PRIMARY KEY (`non_member_id`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;

CREATE TABLE `parking_spot` (
    `lot_no` int (11) NOT NULL,
    `spot_no` int (11) NOT NULL,
    `building_name` varchar(100) NOT NULL,
    PRIMARY KEY (`lot_no`, `spot_no`, `building_name`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `reservation` (
    ...
    CONSTRAINT `reservation_date` FOREIGN KEY (`reservation_date`) REFERENCES `calendar` (`reservation_date`)) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
